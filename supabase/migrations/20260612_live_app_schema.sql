...
insert into public.email_templates (key, title, subject, body) values
  ('registration', 'Registrácia vlastníka', 'Vitajte v e - Housing Solutions Licence pre SVB a NP Družstevná 386', 'Dobrý deň, bol Vám vytvorený prístup do aplikácie e - Housing Solutions Licence.'),
